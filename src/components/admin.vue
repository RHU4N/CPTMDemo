<template>
  <div class="admin-container">
    <!-- Header único -->
    <AppHeader :title="tituloHeader" @open-configs="abrirConfigs" @click-logo="voltarTelaInicial" />
    ...
    <main class="admin-content">
      ...
      <div v-if="!abrindoFormulario && !abrindoHistorico">
        ...
        <div class="mapa-lista">
          <div class="mapa">
            <p>Mapa com localizações dos usuários</p>
          </div>
      ...
      <!-- Outras telas do Admin (Admin, Logs, Chamados) -->
...
// Lista de inspeções (agora mostrando user)
...
// Lista de usuários para o mapa + status
const usuarios = reactive([
  { id:1, nome:'user1', status:'online' },
  { id:2, nome:'user2', status:'offline' },
  { id:3, nome:'user3', status:'online' },
])
...
// Finaliza formulário e adiciona inspeção com usuário padrão "admin"
...
// Voltar à tela principal do Admin
